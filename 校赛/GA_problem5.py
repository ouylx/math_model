...
data_1 = pd.read_excel(r'C:\Users\25492\Desktop\2024杭电第14届研究生数学建模竞赛赛题\2024杭电数模校赛——研究生14届赛题B题\附件数据（B题）\附件5'
                       r'\Ins3_20_50_10.xlsx', sheet_name='包装种类及其所需墨盒')
data_2 = pd.read_excel(r'C:\Users\25492\Desktop\2024杭电第14届研究生数学建模竞赛赛题\2024杭电数模校赛——研究生14届赛题B题\附件数据（B题）\附件5'
                       r'\Ins3_20_50_10.xlsx', sheet_name='墨盒切换时间', index_col=0)
...
mutation_rate = 0.3
cross_rate = 0.8
problem = Problem1(box_num, package_num, slot_num, print_info, CleanTime, population_size, generations, cross_rate,
                   mutation_rate)
